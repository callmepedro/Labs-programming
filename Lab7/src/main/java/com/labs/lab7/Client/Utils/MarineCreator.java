...
import com.labs.lab7.common.Exceptions.InvalidValueException;
import com.labs.lab7.common.InitData;

import java.util.Arrays;

import static com.labs.lab7.Client.Utils.ConsoleManager.replyUser;
...
public class MarineCreator {
     ...
     */
    public SpaceMarine create(InitData initData) {
        ...
        if (ConsoleManager.getCommandReader().getCommandReaderMod() == CommandReaderMode.CONSOLE) {
            ...
            return new SpaceMarine(name, coordinates, health, loyal, category, meleeWeapon, chapter, initData);
        }
